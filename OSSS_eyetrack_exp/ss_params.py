...
p = dict(
    ...
    # 0.2*1.14, #0.175, # Where to start the staircase.
    start_target_contrastA=0.28,
    # 0.2*1.14, #0.175, #Where to start the staircase for orthogonal
    # condition.  This will make sure that staircases converge on threshold.
    start_target_orthog_contrastA=0.28,
    # 0.2*1.14, #0.175, # Where to start the staircase.
    start_target_contrastB=0.28,
