...
class Trial(Event):
    ...
    def save(self,f,insert_header=False):
        ...
        f.write('%s, '%self.stimulus.nominal_target_co) # Annulus target contrast
        f.write('%s, '%(self.stimulus.fixation_target.color[0])) # Fixation target contrast
        f.write('%s, '%self.stimulus.target_loc) # Annulus target location
        f.write('%s, '%self.stimulus.fix_target_loc) # Fixation target location
        ...
        f.write('%s, '%self.start_time) # Trial start time -> need to implement
        f.write('%s, '%self.end_time) # Trial end time -> also need to implement 
